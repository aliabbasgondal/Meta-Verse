...
import { checkUser, showBalnace, widthdrawOrTransfer, deposit, accountDetails,accountbalance, loginDetails } from "./account.js";
...
async function ConfirmDetails(acccountBank:any,opt:String) {
    if(opt==='FundTransfer'){
